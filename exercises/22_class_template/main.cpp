            ...
            for (auto i1 = 0u; i1 < shape[1]; ++i1) {
                for (auto i2 = 0u; i2 < shape[2]; ++i2) {
                    for (auto i3 = 0u; i3 < shape[3]; ++i3) {
                        ...
                        auto other0 = others.shape[0] == 1 ? 0 : i0;
                        auto other1 = others.shape[1] == 1 ? 0 : i1;
                        auto other2 = others.shape[2] == 1 ? 0 : i2;
                        auto other3 = others.shape[3] == 1 ? 0 : i3;
                        auto other_index = ((other0 * others.shape[1] + other1) * others.shape[2] + other2) * others.shape[3] + other3;
